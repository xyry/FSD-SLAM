...
public:
    ...
    void CalculEverything_segment( cv::Mat &imRGB,const cv::Mat &imGray,const cv::Mat &imDepth,const cv::Mat &imS);
    ...
    void CalculEverything_detection( cv::Mat &imRGB, const cv::Mat &imGray, const cv::Mat &imDepth, const std::vector<bbox_t> &detect_result );
