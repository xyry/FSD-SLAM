...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const string &pascal_prototxt, const string &pascal_caffemodel, const string &pascal_png, const string &detection_config, const string &detection_weights, const string &object_names,const eSensor sensor=MONOCULAR, 
