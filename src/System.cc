...
System::System(const string &strVocFile, const string &strSettingsFile, const string &pascal_prototxt, const string &pascal_caffemodel, const string &pascal_png, const string &detection_config, const string &detection_weights, const string &object_names, const eSensor sensor,
			   ...
			   mbDeactivateLocalizationMode(false)
{
    ...
    mpTracker = new Tracking(this, mpVocabulary, mpMap, mpPointCloudMapping, mpKeyFrameDatabase, strSettingsFile, mSensor, mpFrameDrawer, mpMapDrawer);
    ...
    float tmpmDetectionRatio=fsSettings["mDetectionRatio"];
    mpSegment =new Segment( pascal_prototxt, detection_config, pascal_caffemodel, detection_weights, pascal_png,tmpmDetectionRatio);
...
void System::Shutdown()
{
    ...
    cout << "--------"<<endl<<endl;
    cout << "Final number of keyframes: " << mpMap->KeyFramesInMap() << std::endl;
    cout << "Final number of map points: " << mpMap->MapPointsInMap() << std::endl;
}
